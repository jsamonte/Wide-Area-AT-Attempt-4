...
namespace Microsoft.MixedReality.WorldLocking.Core
{
    ...
    public partial class AnchorManagerARF : AnchorManager
    {
            ...
            GameObject arSessionOriginSource)
        {
            ...
            XROrigin arSessionOrigin = arSessionOriginSource.GetComponent<XROrigin>();
            if (arSessionOrigin == null)
            {
                DebugLogSetup($"Adding AR session origin to {arSessionOriginSource.name}");
                arSessionOrigin = arSessionOriginSource.AddComponent<XROrigin>();
            }
            if (arSessionOrigin == null)
            {
                Debug.LogError($"Failure acquiring XROrigin from {arSessionOriginSource.name}, can't create AnchorManagerARF");
            }
        ...
        private AnchorManagerARF(IPlugin plugin, IHeadPoseTracker headTracker, ARSession arSession, XROrigin arSessionOrigin) 
